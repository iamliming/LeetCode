...
public class NewTonInterpolation
{
    ...
    public static void main(String[] args) {
       /* *//*输入插值点横纵坐标*//*
        ...
        int m =7,n=1;
        double X[]=new double[]{-3,-2,-1,0,1,0.4,4};
        double Y[]=new double[]{9,4,1,0,1,1.6,16};
        double X0[]=new double[]{0.5,0.3};


        double[] rst = NewTonInterpolation.Newton_inter_method(X, Y,X0);
        for(double r : rst)
